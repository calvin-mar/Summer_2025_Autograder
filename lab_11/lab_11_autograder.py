...
def autoGrader(student_submission):
    ...
    if b_proceed == False:
        ...
        # Test 2: Task 1: Test my_len function with list []
        ...
        try:
            result = assistant.is_inf(sm.my_len, ([8, 6, 7, 5, 3],))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_in_list, ([8, 6, 7, 5, 3],0))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            error_msgs.append(" Failed: Function my_in_list() caused an error. The function might contain an infinite loop or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        elif(result == "Error"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_in_list, ([8, 6, 7, 5, 3], 8))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_location, ([8, 6, 8, 5, 3], 8))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            error_msgs.append(" Failed: Function my_location() caused an error. The function might contain an infinite loop or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        elif(result == "Error"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_location, ([8, 6, 8, 5, 3], 77))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_reverse, ([8, 6, 8, 5, 3],))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            error_msgs.append(" Failed: Function my_reverse() caused an error. The function might contain an infinite loop or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        elif(result == "Error"):
            passes.append(False)
            ...
            if(result == [3, 5, 8, 6, 8]):
                ...
                passes.append(False)
                error_msgs.append(" Failed: my_reverse() should return [3, 5, 8, 6, 8] with this list [8, 6, 7, 5, 3] argument, but it returns " + str(result) + ".</font>")
        ...
        try:
            result = assistant.is_inf(sm.my_extrema, ([77, 6, -1, 5, 3],))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            error_msgs.append(" Failed: Function my_extrema() caused an error. The function might contain an infinite loop or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        elif(result == "Error"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_extrema, ([-1, 6, 3, 5, 77],))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_extrema, ([6, 77, 3, 5, -1],))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_count, ([6, 77, 3, 5, -1], 99))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            error_msgs.append(" Failed: Function my_count() caused an error. The function might contain an infinite loop or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        elif(result == "Error"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_count, ([6, 77, 3, 5, 77], 77))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            ...
            if(result == 2):
                ...
                passes.append(False)
                error_msgs.append(" Failed: my_count() should return 2 with this list [6, 77, 3, 5, 77] and 77 as argument, but it returns " + str(result) + ".</font>")
        ...
        try:
            result = assistant.is_inf(sm.my_insert, ([0, 1, 2, 3, 4], 0, "X"))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            error_msgs.append(" Failed: Function my_insert() caused an error. The function might contain an infinite loop or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        elif(result == "Error"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_insert, ([0, 1, 2, 3, 4], 4, "X"))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_remove, ([0, 1, 2, 3, 4, 1, 2, 1, 2], 1))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            error_msgs.append(" Failed: Function my_remove() caused an error. The function might contain an infinite loop or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        elif(result == "Error"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_remove, ([0, 1, 2, 3, 4, 1, 2, 1, 2], 11))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
        ...
        try:
            result = assistant.is_inf(sm.my_sort, ([8, 7, 6, 5, 4, 3, 2, 1, 0],))
        except:
            result = "Error"
        if(result == "Infinite"):
            passes.append(False)
            error_msgs.append(" Failed: Function my_sort() caused an error. The function might contain an infinite loop or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        elif(result == "Error"):
            passes.append(False)
