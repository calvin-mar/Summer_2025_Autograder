...
class MainWindow(QMainWindow):
    def __init__(self, student_submission):
        ...
        if b_proceed == False:
            ...
            try:
                ...
                try:
                    ...
                    error_code = "crash"
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: Function read_data() caused an error.  The function might not be defined (perhaps you made a typo in the name) or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening! </font>")
                assert result == "AAACCCGGGTTTACTTAGCGA"
                self.result[i_test_num-1] = True
            except:
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: read_data(\"shark.txt\") should return AAACCCGGGTTTACTTAGCGA, but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: read_data(\"elephant.txt\") should return ACGACGTTTAAACCR, but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: is_valid_strand() with strand \"ACGCGTGTATACAAATTT\" should return True, but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: is_valid_strand() with an invalid strand should return False, but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: num_differences() with 2 identical strands should return 0, but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: num_differences() with these strands \"TAACGCTGGTGTACA\" and \"AAACCCGGGTTTACT\" should return 5, but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                try:
                    ...
                    error_code = "crash"
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: Function complement() caused an error.  The function might not be defined (perhaps you made a typo in the name) or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening! </font>")
                assert result == "TTTGGGCCCAAATGA"
                self.result[i_test_num-1] = True
            except:
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: complement() with strand \"AAACCCGGGTTTACT\" should return \"TTTGGGCCCAAATGA\", but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                try:
                    ...
                    error_code = "crash"
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: Function get_triplets() caused an error.  The function might not be defined (perhaps you made a typo in the name) or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening! </font>")
                assert result == ["ACG", "CGT", "GTA", "TAC", "AAA", "TTT"]
                self.result[i_test_num-1] = True
            except:
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: get_triplets() with strand \"ACGCGTGTATACAAATTT\" should return [\"ACG\", \"CGT\", \"GTA\", \"TAC\", \"AAA\", \"TTT\"], but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: get_amino_acids() with argument [\"ACG\", \"CGT\", \"GTA\", \"TAC\", \"AAA\", \"TTT\"] should return \"TRVYKF\", but it returns " + str(result) + ".</font>")
            ...
            try:
                ...
                try:
                    ...
                    error_code = "crash"
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: Function get_acid() caused an error.  The function might not be defined (perhaps you made a typo in the name) or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening! </font>")
                assert result1 == "F"
                assert result2 == "F"
                assert result3 == "L"
                assert result4 == "L"
                ...
                if error_code != "crash":
                    object.setText("<img src='octagon.png' width='32' height='32'><font color=black>Test " + str(i_test_num) + " Failed: get_acid() returns an incorrect value for one of the 64 inputs! Which one?  Happy debugging! </font>")
        ...
        self.setWindowTitle('Bioinformatics Lab Autograder')
        self.show()
...
def testing(queue):
	window = MainWindow("lab_13_student_submission.py")
	ret = queue.get()
