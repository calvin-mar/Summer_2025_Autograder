...
def autoGrader(student_submission, window):
    ...
    if b_proceed == False:
        ...
        try:
            result = window.testFunction(sm.get_estimate)
            if(result[1]):
        ...
        l_data = shm.ShareableList([1, 2, 3, 4, 5, 6], name="l_data")
        try:
            result = window.testFunction(sm.get_quantities)
            if(result[1]):
                result[0] = result[0] + " The inputs were 1, 2, 3, 4, 5, 6. </font>"
                error_msgs.append(result[0])
                passes.append(False)
        ...
        try:
            result = window.testFunction(sm.validate_combination, (12, 33, 0))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_combination, (-1, 33, 0))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_combination, (33, -1, 0))
            if(result[1]):
                ...
                if(result[0] == False):
                    ...
                    passes.append(False)
                    error_msgs.append(" Failed: validate_combination() should return False with second number &#60; 0. Instead it returned " + str(window.spaces(result[0])) + "</font>")
        except:
            passes.append(False)
            error_msgs.append(" Failed: Function validate_combination() caused an error. The function might not be defined (perhaps you made a typo in the name) or it may contain code inside it that causes Python to crash.  Try adding some print statements to it to see what is happening!</font>")
        ...
        try:
            result = window.testFunction(sm.validate_combination, (12, 33, -1))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_combination, (40, 33, 0))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_combination, (1, 40, 0))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_combination, (20, 33, 40))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_combination, (33, 33, 0))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_combination, (0, 33, 33))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.order_combo_meal, (1,2,4))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.order_combo_meal, (0, 1, 1))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.order_combo_meal, (1,0,1))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.order_combo_meal, (1,1,0))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.get_item_price, ("drink", 4))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.get_item_price, ("sandwich", -1))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.get_item_price, ("sandwich", 5))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_meal, (1, 1, 1))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_meal, (0, 1, 1))
            if(result[1]):
                result[0] = result[0] + " The parameters were 0, 1, 1. </font>"
                error_msgs.append(result[0])
                passes.append(False)
        ...
        try:
            result = window.testFunction(sm.validate_meal, (1, 0, 1))
            if(result[1]):
                result[0] = result[0] + " The parameters were 1, 0, 1. </font>"
                error_msgs.append(result[0])
                passes.append(False)
        ...
        try:
            result = window.testFunction(sm.validate_meal, (1, 1, 0))
            if(result[1]):
                result[0] = result[0] + " The parameters were 1, 1, 0. </font>"
                error_msgs.append(result[0])
                passes.append(False)
        ...
        try:
            result = window.testFunction(sm.validate_meal, (4, 1, 0))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_meal, (1, 3, 1))
            if(result[1]):
        ...
        try:
            result = window.testFunction(sm.validate_meal, (1, 1, 5))
            if(result[1]):
