...
def autoGrader(student_submission, window):
    ...
    if b_proceed == False:
        ...
        try:
            ...
            passes.append(False)
            error_msgs.append(" Failed: Make sure the variable i_task_21_start exists and has the correct value. </font>")
...
def testing(window):
    passes, error_msgs = autoGrader("lab_12_student_submission.py", window)
    return passes
