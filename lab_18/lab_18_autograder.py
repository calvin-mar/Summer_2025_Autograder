...
from lab_18_student_submission import *
import lab_18_student_submission
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        try:
            input_file = open("lab_18_student_submission.py", "r")
        ...
        if s_triple_res == "No Triples":
            ...
            with open("lab_18_student_submission.py","r") as f:
                code = f.read() 
