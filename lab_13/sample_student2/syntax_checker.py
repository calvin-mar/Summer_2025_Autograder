...
class MainWindow(QMainWindow):
    ...
    def __init__(self, filename):
        ...
        widget = QWidget()
        layout = QVBoxLayout()
        message = QLabel("<b>Syntax Checker is running...<br> Please be patient.</b>")
        font = widget.font()
        ...
        self.show()
        self.startSyntaxChecker(filename)
    ...
    def startSyntaxChecker(self,filename):
        self.thread = QThread()
        self.worker = Worker(filename, self)
    ...
    def updateWindow(self):
      ...
      # Summary screen is its own HBox layout inside the Vbox
        ...
        if self.passes[0]:
            ...
            text.setText("<font size=5>Syntax is all good!</font>")
            num_passed += 1
        else:
            image.setText(f"<img src='{redX}' width='32' height='32'>")
            text.setText("<font color=black size=5>You have a problem with your syntax<br></font>" + self.error_msgs[error_count])
